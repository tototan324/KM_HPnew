            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <div class="border-t border-gray-100 pt-8 mt-auto">
                        <a href="<?php echo esc_url(marukan_get_permalink_by_slug('contact')); ?>" class="inline-flex items-center gap-4 bg-marukanBlue text-white px-10 py-5 rounded-full text-lg font-bold transition-all hover:bg-blue-800 hover:-translate-y-1 hover:shadow-xl">
                            この商品について問い合わせる
