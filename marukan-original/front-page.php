...
<section id="members" class="py-24 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-5xl mx-auto space-y-24">
            ...
            ?>
                <div class="flex flex-col <?php echo $is_even ? 'md:flex-row-reverse' : 'md:flex-row'; ?> items-center gap-12 md:gap-20">
                    ...
                    <div class="w-full md:w-3/5">
                        <?php if ($dept) : ?>
                            <span class="inline-block bg-blue-50 text-marukanBlue text-xs font-bold px-4 py-1 rounded-full mb-6"><?php echo esc_html($dept); ?></span>
                        <?php endif; ?>
                        <h3 class="text-2xl md:text-3xl font-bold mb-6"><?php echo strip_tags(get_the_excerpt()); ?></h3>
            ...
            <?php $idx++; endwhile; wp_reset_postdata(); else : ?>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex justify-center">
                ...
                ?>
                <a href="<?php echo esc_url($contact_url); ?>" class="group relative inline-flex items-center gap-4 bg-marukanBlue text-white px-16 py-8 rounded-full text-2xl font-bold transition-all duration-500 hover:bg-blue-800 hover:-translate-y-2 hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)]">
                    お問い合わせフォーム
